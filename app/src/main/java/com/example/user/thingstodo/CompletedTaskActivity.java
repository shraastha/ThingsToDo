...
public class CompletedTaskActivity extends AppCompatActivity {
    ...
    public void readTasks() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(API.URL_COMPLETED_TASK, params, CODE_POST_REQUEST);
        request.execute();
    }
...
//        taskList.clear();
        ...
        Log.e("Task Completed Size", String.valueOf(taskList.size()));
