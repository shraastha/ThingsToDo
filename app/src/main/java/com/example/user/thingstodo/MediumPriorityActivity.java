...
public class MediumPriorityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_priority);
    ...
    public void readTasks() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(API.URL_MP_TASK, params, CODE_POST_REQUEST);
        request.execute();
    }
