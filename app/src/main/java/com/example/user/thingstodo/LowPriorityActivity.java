...
public class LowPriorityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_low_priority);
    ...
    public void readTasks() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(API.URL_LP_TASK, params, CODE_POST_REQUEST);
        request.execute();
    }
