...
public class DueTaskActivity extends AppCompatActivity {
    ...
    public void readTasks() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(API.URL_DUE_TASK, params, CODE_POST_REQUEST);
        request.execute();
    }
